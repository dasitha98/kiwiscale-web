...
>>>>>>> Stashed changes
  ...
  hero: {
    ...
    trustLine:
      "NZ-ready • Strategy-first • Compete smarter • Measurable outcomes",
  },
  ...
  painPoints: [
    "Inconsistent or unpredictable client inquiries",
    "Low website conversion rates despite traffic",
    "Weak online visibility against competitors",
    "Ad spend with unclear return on investment",
    "No connected system linking marketing to outcomes",
    "Outdated website that doesn't reflect your value",
  ],
  ...
  pillars: [
    {
      title: "Attract",
      description:
        "Drive qualified traffic through SEO, content & paid channels",
    },
    {
      title: "Capture",
      description:
        "Convert visitors with high-impact landing pages & lead magnets",
    },
    {
      title: "Convert",
      description: "Nurture leads with automated follow-ups & smart tracking",
    },
    {
      title: "Scale",
      description: "Optimise & expand what works with data-driven decisions",
    },
  ],
  ...
  differentiators: [
    {
      ...
      description: "Every engagement starts with a clear plan, not guesswork.",
    },
    {
      title: "Measurable Reporting",
      description:
        "Track real metrics that matter — leads, conversions, revenue.",
    },
    {
    ...
    },
    {
      ...
      description: "Built to grow with you, not hold you back.",
    },
    {
      title: "NZ-Ready Communication",
      description: "Local understanding, global-quality execution.",
    },
  ],
  ...
  beforeAfter: {
    before: [
      ...
      "Inconsistent, unpredictable inquiries",
      "Low conversion rate on campaigns",
      "No automation or follow-up system",
    ],
    after: [
      "Conversion-ready, modern website",
      "Stronger visibility across channels",
      "Consistent, qualified inquiries",
      "Measurable, connected marketing system",
    ],
  },
  ...
  services: [
    {
      ...
      solves:
        "Outdated sites that don't generate leads or reflect your brand value.",
      outcomes:
        "A fast, modern website designed to convert visitors into clients.",
    },
    {
      ...
      solves:
        "The need for a mobile presence to reach clients wherever they are.",
      outcomes: "A polished, functional app that extends your brand reach.",
    },
    {
      title: "SEO",
      slug: "seo",
      ...
      outcomes:
        "Higher search positions, more organic traffic, and qualified leads.",
    },
    {
      ...
      outcomes:
        "An engaged audience and a consistent flow of social-driven leads.",
    },
    {
      ...
      outcomes:
        "Fresh, relevant content that supports SEO and brand authority.",
    },
  ],
  ...
  sampleWork: [
    {
      ...
      label: "Sample",
      problem:
        "Outdated website with no lead capture or mobile responsiveness.",
      approach:
        "Full redesign with conversion-focused layout, SEO, and lead forms.",
      outcome: "Expected 3x increase in qualified inquiries within 90 days.",
    ...
    },
    {
      ...
      label: "Sample",
      problem:
        "New brand with zero online presence needing rapid market entry.",
      approach: "Brand strategy, Shopify build, Meta Ads + Google Ads launch.",
      outcome: "Expected 200+ orders in first month with positive ROAS.",
      image: "/placeholder.svg",
    },
    {
      title: "SaaS MVP Build",
      label: "Currently Building",
      problem: "Business idea validated but no technical product in market.",
      approach: "Lean MVP with React Native, cloud backend, and analytics.",
      outcome: "Launch-ready product within 8 weeks for beta testing.",
      image: "/placeholder.svg",
    },
  ],
  ...
  launchPlan: [
    {
      ...
      description:
        "Deep dive into your current setup, goals, and competitive landscape.",
    },
    {
      days: "Day 3–5",
      title: "Strategy Blueprint",
      description:
        "Custom roadmap with channels, messaging, and conversion plan.",
    },
    {
      days: "Day 6–10",
      title: "Build & Tracking",
      description:
        "Website updates, ad setup, tracking pixels, and landing pages.",
    },
    {
      days: "Day 11–14",
  ...
  launchChecklist: [
    ...
    "Brand assets (logo, colours, images)",
    "Google Analytics and ad account access",
    "Key business goals and target audience info",
  ...
  pitfalls: [
    {
      title: "Template websites that can't grow into a system",
      description: "Looks nice, but limits features as your business grows.",
    },
    {
      title: "Third-party dependency",
      description: "Important upgrades require external developers.",
    },
    {
      title: "No foundation for scaling",
      description: "Tracking, automations, CRM, portals become difficult.",
    },
    {
      title: "Surprise budgets when you need real growth",
      description:
        "You pay again to rebuild what should've been planned from day one.",
    },
  ],
