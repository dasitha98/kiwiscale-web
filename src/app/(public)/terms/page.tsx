    ...
    <main className="section-padding">
      <div className="container-narrow mx-auto max-w-3xl prose prose-sm">
        ...
        <p className="text-muted-foreground">
          {siteConfig.name} provides digital marketing, web development, and
          technology consulting services as agreed upon in individual project
          scopes.
        </p>

        <h2 className="mt-6 text-xl font-bold">2. Payment</h2>
        <p className="text-muted-foreground">
          Payment terms are outlined in individual project agreements. All fees
          are in NZD unless otherwise stated.
        </p>

        <h2 className="mt-6 text-xl font-bold">3. Intellectual Property</h2>
        <p className="text-muted-foreground">
          Upon full payment, clients receive ownership of all deliverables
          unless otherwise agreed. Third-party licenses remain with their
          respective owners.
        </p>

        <h2 className="mt-6 text-xl font-bold">4. Limitation of Liability</h2>
        <p className="text-muted-foreground">
          Our liability is limited to the fees paid for the specific services in
          question. I do not guarantee specific business outcomes.
        </p>
