      ...
      <section className="section-padding">
        <div className="container-narrow mx-auto">
          ...
          <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
            Sample projects and active builds. Real case studies will replace
            these as I deliver results.
          </p>
          ...
          <div className="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {siteConfig.sampleWork.map((work, i) => (
              ...
              >
                ...
                <Link
                  href={`/work/${i}`}
                  className="mt-6 inline-flex items-center gap-1 text-sm font-semibold transition-colors hover:text-gold"
                >
