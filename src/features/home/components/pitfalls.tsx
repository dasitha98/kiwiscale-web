    ...
    <div className="container-narrow mx-auto">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
          Avoid these common traps that look fine at first — but quietly drain
      ...
      <div className="mt-14 grid gap-8 md:grid-cols-2">
        <div className="space-y-4">
          {siteConfig.pitfalls.map((pitfall, i) => (
            <div
              key={i}
              className="flex items-start gap-4 rounded-xl border border-border bg-background p-5 transition-all duration-300 hover:border-gold/30 hover:shadow-sm"
            >
      ...
      <div className="mt-12 text-center">
        <p className="text-sm text-muted-foreground">
          Not sure if your setup can scale? I&apos;ll review it — free.
        </p>
