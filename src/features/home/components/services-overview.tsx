    ...
    <div className="container-narrow mx-auto">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
          Everything you need to attract, convert, and retain high-value
          clients.
        </p>
      </div>
      ...
      <div className="mt-14 space-y-6">
        {siteConfig.services.map((service, i) => {
          ...
          return (
            <div
              key={service.slug}
              className="card-elevated grid gap-6 p-8 md:grid-cols-[auto_1fr_1fr]"
            >
              ...
              <div className="flex flex-col justify-between">
                ...
                <Link
                  href="/contact"
                  className="mt-4 inline-flex items-center gap-2 text-sm font-bold transition-colors hover:text-gold"
                >
