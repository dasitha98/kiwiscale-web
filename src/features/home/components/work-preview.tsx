...
const WorkPreviewSection = () => {
  ...
  const buildingWork = siteConfig.sampleWork.filter(
    (w) => w.label === "Currently Building",
  );
      ...
      <div className="container-narrow mx-auto">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            A look at what I&apos;re building. Real case studies coming soon.
          </p>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((work, i) => (
            <div
              key={i}
              className="card-elevated flex flex-col p-7 transition-all duration-300"
            >
              <span
              ...
              <div className="mt-4 flex-1 space-y-3 text-sm text-muted-foreground">
                ...
                <p>
                  <strong className="text-foreground/80">Expected:</strong>{" "}
                  {work.outcome}
                </p>
              </div>
              <Link
