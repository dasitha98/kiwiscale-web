      ...
      <div className="container-narrow mx-auto max-w-3xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-muted-foreground">
            Tell us about your project. I respond within 24 hours.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="mt-12 space-y-5">
            <div className="grid gap-5 sm:grid-cols-2">
              <input
                ...
                required
                className="rounded-xl border border-border bg-background px-5 py-3.5 text-sm outline-none transition-all focus:border-gold focus:ring-2 focus:ring-gold/20"
              />
              <input
                type="email"
                placeholder="Email *"
            ...
            <textarea
              ...
              required
              rows={5}
              className="w-full rounded-xl border border-border bg-background px-5 py-3.5 text-sm outline-none transition-all focus:border-gold focus:ring-2 focus:ring-gold/20"
            />
