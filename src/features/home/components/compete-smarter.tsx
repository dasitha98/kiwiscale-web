    ...
    <div className="container-narrow mx-auto">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
          I help you stand out, attract the right clients, and convert them
          consistently.
        </p>
      </div>
        ...
        {[
          {
            ...
            desc: "Clarify what makes you unique and communicate it with authority across every channel.",
          },
          {
            icon: Layers,
            title: "Balanced Acquisition Mix",
            desc: "SEO, social media, and paid advertising working together for sustainable growth.",
          },
          {
            icon: BarChart3,
            title: "Conversion System",
            desc: "Landing pages, tracking, and follow-up sequences that turn interest into revenue.",
          },
        ].map((item) => (
