  ...
  <section id="offer" className="section-padding bg-background">
    <div className="container-narrow mx-auto">
      <div className="text-center">
        ...
        <h2 className="mt-4 text-3xl font-bold sm:text-4xl">What I Offer</h2>
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
          Everything you need to attract, convert, and scale — built as one
          system.
        </p>
      </div>
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {cap.tags.map((tag) => (
                <span
                  key={tag}
                  className="inline-flex items-center rounded-full border border-gold/30 bg-gold/5 px-3 py-1 text-xs font-semibold text-gold"
                >
                  {tag}
                </span>
              ))}
